...
public abstract class GUI {
	...
	protected abstract void clickedStart();
	protected abstract void clickedEnd();
	protected abstract void starPath();
	/**
	...
	private void initialise() {
		...
		//finds path and redraws
		JButton findPath = new JButton("Find the best path");
